...
def slot_example(status_bar):
    def inner():                       # usando o inner estou atrasando a funcao
...
status_bar.showMessage('Mostrar messagem na barra')
...
segunda_action.setCheckable(True) # vai ser marcada agora
